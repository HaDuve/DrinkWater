export const en = {
  ...
  settings: {
    ...
    reminderPlanPreview:
      "{{count}} glasses between {{start}} and {{end}} · every {{interval}} min",
    reminderPlanPreviewSingle:
      "{{count}} glass between {{start}} and {{end}}",
  ...
  reminder: {
    ...
    nextAtToday: "Next reminder at {{clockTime}}.",
    doneForToday: "Today's reminders done. Next at {{clockTime}}.",
